...
|--------------------------------------------------------------------------
|
| Here is where you can register web routes for your frontend.
|
*/

Route::get('/', [FrontendController::class, 'index'])->name('index');
Route::get('/campaigns/{slug}', [FrontendController::class, 'setCampaign'])->name('setCampaign');
...
Route::get('/real/start/{confirm}', [FrontendController::class, 'realStart'])->name('real.start');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/video/{filename}', function ($filename) {
        // Pasta dos videos.
        $videosDir = base_path('public/storage/Interview');
