        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            ...
            <div class="video-list" id="video-list">
                <ul>
                    ...
                    <li>
                        <a href="{{ asset('storage/Interview/'.$interview->file) }}" data-id="{{ $interview->id }}"  data-rate="{{ $interview->rate }}"  data-comment="{{ $interview->comment }}"  data-question="{{ $interview->question->name }}">
                            <img src="{{ asset('storage/Avatar/'.$applicant->image) }}"/>
                            <div class="question_body">
                                <div class="question_nav">
                                    <span class="question_label">{{ \Illuminate\Support\Str::limit($interview->question->name, 8, $end='...') }}</span>
                                </div>
                            </div>
                        </a>
                    </li>
        ...
        <div class="col-md-3 col-sm-4 col-xs-12">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <p style="position: absolute; width:fit-content;" title="Rate : {{ $applicant->mark + 0 }}">
            ...
            <div class="comment">
                ...
                <textarea name="comment" id="comment" rows="5">@if($comment){{ $comment->comment}}@endif</textarea>
                ...
                <div class="form-group">
                    <button type="button" class="btn btn-success" id="saveComment" data-id="{{ $applicant->id }}">Save</button>
                </div>
            </div>
        </div>
    </div>
